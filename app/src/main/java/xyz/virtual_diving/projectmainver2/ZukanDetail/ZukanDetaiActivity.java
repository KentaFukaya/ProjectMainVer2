...
public class ZukanDetaiActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void setALL(){
        ...
        imageView.setImageResource(R.drawable.zukanlist_sakana0+ zukanDetail.getImageUrl());
        //魚の名前の表示
